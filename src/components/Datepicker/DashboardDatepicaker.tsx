...
function DashboardDatepicaker({
  ...
  return (
    <div className="pt-1 pb-1 flex flex-row gap-1 items-end justify-start shrink-0 relative">
      <svg
      ...
      <div
        className="flex flex-row gap-2 items-center justify-start shrink-0 w-[748px] md:w-[250px] sm:w-[200px] lg:w-[300px] xl:w-[748px]  relative no-scrollbar"
          ...
          if (typeof page === 'number') {
            return (
              <div
                ...
                } rounded-[8px] pt-px pr-[9px] pb-px pl-[9px] flex flex-col gap-2.5 items-center justify-center shrink-0 w-7 h-7 relative overflow-hidden cursor-pointer hover:bg-[#e6effc] hover:text-black`}
              >
                <div
                  className={`${
                    page === pageIndex ? 'text-[#ffffff]' : 'text-[#858e93]'
                  } text-left relative flex items-center justify-start`}
                  style={{
      ...
      <svg
        ...
        onClick={() => nextPage()}
      >
        <path d="M10.5 7L17.5 14L10.5 21" stroke="#BBC0C3" strokeWidth="2" />
      </svg>
    </div>
  );
}
