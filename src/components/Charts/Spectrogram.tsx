...
function generateData(theta: any, min: any, max: any) {
  const data = [];
  for (let i = 0; i <= 200; i++) {
    for (let j = 0; j <= 100; j++) {
    ...
    this.state = {
      option: {
        tooltip: {
          ...
          //   return (
          //     'Time : ' + params[0].value[0] + ', ' + 'Frequency : ' + params[0].data[2]
          //   );
          // },
          // axisPointer: {
          //   animation: false,
        ...
        visualMap: {
          ...
          itemHeight: '313',
          inRange: {
            color: ['#00007F', '#007FFF', '#7FFF7F', '#FF7F00', '#7F0000'],
            // color: ['#44ff00', '#e3c607', 'red'],
            // symbolSize: [30, 100],
            // color: ['#f56725', '#d65200', '#44ff00', '#fff942', '#e3c607', '#fa052e'],
          },
        },
        series: [
          {
