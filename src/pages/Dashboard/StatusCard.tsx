...
function StatusCard() {
  return (
    <div className="bg-[#e6effc] rounded-[25px] shrink-0 min-w-[330px] min-h-[255px] relative overflow-hidden">
      ...
      <div
        className="text-[#545a5f] text-left absolute right-6 top-6"
        style={{ font: "500 12px/26px 'Mulish', sans-serif" }}
      >
        5 min ago{' '}
      </div>
      <div className="flex flex-col gap-1 items-start justify-start w-[282px] absolute left-[calc(50%_-_141px)] bottom-6">
        ...
        <div className="bg-[#ffffff] rounded-[10px] p-2 flex flex-col gap-2 items-center justify-center self-stretch shrink-0 relative">
          <div className="flex flex-row gap-1.5 items-center justify-start self-stretch shrink-0 relative">
            <div className="bg-[#33415b] rounded-[5px] p-2 flex flex-row gap-2.5 items-start justify-start shrink-0 relative overflow-hidden">
              <svg
            ...
            <div className="bg-[#33415b] rounded-[5px] border-solid border-[transparent] border pt-[3px] pr-2.5 pb-[3px] pl-2.5 flex flex-col gap-px items-center justify-center flex-1 relative">
              <div
            ...
            <div className="bg-[#efa71c] rounded-[5px] border-solid border-[transparent] border pt-[3px] pr-2.5 pb-[3px] pl-2.5 flex flex-col gap-px items-center justify-center flex-1 relative">
              <div
                className="text-[#ffffff] text-left relative flex items-center justify-start"
                style={{ font: "800 10px 'Mulish', sans-serif" }}
              >
          ...
          <div className="flex flex-row gap-1.5 items-start justify-start self-stretch shrink-0 relative">
            <div className="bg-[#33415b] rounded-[4px] pt-[9px] pr-3.5 pb-[9px] pl-3.5 flex flex-row gap-2.5 items-center justify-center flex-1 h-9 relative overflow-hidden">
              <div
                className="text-[#ffffff] text-left relative flex items-center justify-start"
                style={{ font: "800 10px 'Mulish', sans-serif" }}
              >
            ...
            <div className="bg-[#ffffff] rounded-[4px] border-solid border-[#f2be5a] border-[3px] pt-[9px] pr-3.5 pb-[9px] pl-3.5 flex flex-row gap-2.5 items-center justify-center flex-1 h-9 relative overflow-hidden">
              <div
      ...
      <div className="bg-[#ffffff] rounded-[11px] pt-1 pr-2 pb-1 pl-2 flex flex-row gap-[5px] items-center justify-center absolute left-6 top-[60px]">
        ...
        <div
          className="text-[#2ace60] text-center relative flex items-center justify-center"
          style={{
